        ...
        <div className="wrap max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="module-card reveal" style={{ transitionDelay: '0.1s' }}>
              ...
              <h3 className="text-[var(--ink)] font-bold text-xl mb-3">1. Advertising Intelligence</h3>
              <p className="text-[var(--ink)] opacity-60 text-base leading-relaxed mb-6 flex-1">
              ...
              <div className="t-data text-xs text-[var(--ink)] opacity-40 border-t border-[var(--hairline-d)] pt-4">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.2s' }}>
              ...
              <h3 className="text-[var(--ink)] font-bold text-xl mb-3">2. Inventory Intelligence</h3>
              <p className="text-[var(--ink)] opacity-60 text-base leading-relaxed mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.3s' }}>
              ...
              <h3 className="text-[var(--ink)] font-bold text-xl mb-3">3. Listing & Content</h3>
              <p className="text-[var(--ink)] opacity-60 text-base leading-relaxed mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.4s' }}>
              ...
              <h3 className="text-[var(--ink)] font-bold text-xl mb-3">4. Pricing Intelligence</h3>
              <p className="text-[var(--ink)] opacity-60 text-base leading-relaxed mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.5s' }}>
              ...
              <h3 className="text-[var(--ink)] font-bold text-xl mb-3">5. Financial Intelligence & P&L</h3>
              <p className="text-[var(--ink)] opacity-60 text-base leading-relaxed mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.6s' }}>
              ...
              <h3 className="text-[var(--ink)] font-bold text-xl mb-3">6. Brand Health</h3>
              <p className="text-[var(--ink)] opacity-60 text-base leading-relaxed mb-6 flex-1">
