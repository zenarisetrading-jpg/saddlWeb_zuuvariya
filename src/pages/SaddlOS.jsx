        ...
        <div className="wrap max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="module-card reveal" style={{ transitionDelay: '0.1s' }}>
              ...
              <h3 className="t-body font-bold mb-2">1. Advertising Intelligence</h3>
              <p className="t-body-sm text-[var(--muted)] mb-6 flex-1">
              ...
              <div className="t-data text-[var(--muted)] border-t border-[var(--hairline-d)] pt-4 mt-auto">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.2s' }}>
              ...
              <h3 className="t-body font-bold mb-2">2. Inventory Intelligence</h3>
              <p className="t-body-sm text-[var(--muted)] mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.3s' }}>
              ...
              <h3 className="t-body font-bold mb-2">3. Listing & Content</h3>
              <p className="t-body-sm text-[var(--muted)] mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.4s' }}>
              ...
              <h3 className="t-body font-bold mb-2">4. Pricing Intelligence</h3>
              <p className="t-body-sm text-[var(--muted)] mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.5s' }}>
              ...
              <h3 className="t-body font-bold mb-2">5. Financial Intelligence & P&L</h3>
              <p className="t-body-sm text-[var(--muted)] mb-6 flex-1">
            ...
            <div className="module-card reveal" style={{ transitionDelay: '0.6s' }}>
              ...
              <h3 className="t-body font-bold mb-2">6. Brand Health</h3>
              <p className="t-body-sm text-[var(--muted)] mb-6 flex-1">
